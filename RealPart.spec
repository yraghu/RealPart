...
pushd cpp
./reconf
%define _bindir %{_prefix}/dom/components/RealPart/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/%{name}/RealPart.scd.xml
%{_prefix}/dom/components/%{name}/RealPart.prf.xml
%{_prefix}/dom/components/%{name}/RealPart.spd.xml
