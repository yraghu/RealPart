...
PREPARE_LOGGING(RealPart_i)

RealPart_i::RealPart_i(const char *uuid, const char *label) :
    RealPart_base(uuid, label)
{

}

RealPart_i::~RealPart_i()
{
}
...
/***********************************************************************************************
    ...
    Properties:
        ...
        addPropertyChangeListener(<property name>, this, &RealPart_i::<callback method>)
        in the constructor.
        ...
        RealPart_i::RealPart_i(const char *uuid, const char *label) :
            RealPart_base(uuid, label)
        {
            addPropertyChangeListener("scaleValue", this, &RealPart_i::scaleChanged);
        }

        void RealPart_i::scaleChanged(const float *oldValue, const float *newValue)
        {
